...
cbuffer	static_globals
{
	...
	uniform float4		rain_params;		// x=rain density, y=wetness intensity
	uniform float4		fog_plane;
	uniform float4		fog_params;		// x=near*(1/(far-near)), y=base height, z=sky gradient, w=-1/(far-near)
	uniform float4		fog_ground_params;	// x=height, y=intensity, z=density, w=intensity of sun color
	...
	// Shader exports for debug
	uniform float4		m_shader_const_1;	// console command r_shader_const_1
	uniform float4		m_shader_const_2;	// console command r_shader_const_2
	uniform float4		m_shader_const_3;	// console command r_shader_const_3
	uniform float4		m_shader_const_4;	// console command r_shader_const_4
