...
uniform half4                m_shader_const_1;                        // console command r_shader_const_1
uniform half4                m_shader_const_2;                        // console command r_shader_const_2
uniform half4                m_shader_const_3;                        // console command r_shader_const_3
uniform half4                m_shader_const_4;                        // console command r_shader_const_4
